...
public class In_Employee_Operation_Mapping_Activity extends AppCompatActivity implements View.OnClickListener, GetResult.MyListener {
    ...
    ArrayList results = new ArrayList<In_Employee_Data_Object>();
    int i = 0;
    ...
    private ArrayList<In_Employee_Data_Object> getDataSet() {
//        ArrayList results = new ArrayList<In_Employee_Data_Object>();
        try {
            ...
            while (employee_contents.hasNext()) {
                ...
                if (employee_jsonobj.get(key) instanceof JSONObject) {
                    ...
                    In_Employee_Data_Object obj = new In_Employee_Data_Object(empcode, empname, imgpath, hrmsrecid, operationid, hrmssecid,designation_name, operation_name, process_name, section_name, qrcontractorid, currentstatus, current_inoutimte, noofconsecutiveabsentdays, selecteddate, mobileno);
                    results.add(i, obj);
                    i++;
                }
            }
    ...
    public void clearfunc() {
        ...
        Intent intent = new Intent(In_Employee_Operation_Mapping_Activity.this, Empty_Employee_Data_Activity.class);
        intent.putExtra("type", type);
        intent.putExtra("processorid", processorid);
        intent.putExtra("myversionName", myversionName);
        intent.putExtra("selected_type", selected_type);
        In_Employee_Operation_Mapping_Activity.custPrograssbar_new.closePrograssBar();
    ...
    private void fetch_employee_Details() {
        ...
        In_Employee_Operation_Mapping_Activity.custPrograssbar_new.prograssCreate(this);
        ...
        else
        {
            ...
            try {
                ...
                call = APIClient.getInterface().fetch_employee_in_details((JsonObject) jsonParser.parse(jsonObject.toString()));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgd:
                PopupMenu popup = new PopupMenu(In_Employee_Operation_Mapping_Activity.this, imageView);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.log) {
                            ...
                            Intent intent = new Intent(In_Employee_Operation_Mapping_Activity.this, ChangepasswordActivity.class);
                            startActivity(intent);
                            finish();
                        }
                        return true;
    ...
    public void onBackPressed() {
        session = new SessionManagement(getApplicationContext());
        HashMap<String, String> user = session.getUserDetails();
        Intent intent = new Intent(In_Employee_Operation_Mapping_Activity.this, Select_Employee_Detail_Activity.class);
        intent.putExtra("selected_type", selected_type);
        intent.putExtra("type", type);
        intent.putExtra("myversionName", myversionName);
        ...
        try {
            ...
            if (callNo.equalsIgnoreCase("employee_details")) {
                ...
                if (mStatus.equals("success")) {
                    ...
                    mLayoutManager = new LinearLayoutManager(In_Employee_Operation_Mapping_Activity.this);
                    mRecyclerView.setLayoutManager(mLayoutManager);
                    mAdapter = new In_Employee_Operation_Mapping_View_Adapter(this,getDataSet());
                    mRecyclerView.setAdapter(mAdapter);

                    ((In_Employee_Operation_Mapping_View_Adapter) mAdapter).setOnItemClickListener(new In_Employee_Operation_Mapping_View_Adapter.MyClickListener() {
                        @Override
                        public void onItemClick(int position, View v) {

                        String empcode =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getEmpcode(new String(String.valueOf(position)));
                        String empname =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getEmpname(new String(String.valueOf(position)));
                        String imgpath =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getImgpath(new String(String.valueOf(position)));
                        String hrmsrecid =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getHrmsrecid(new String(String.valueOf(position)));
                        String operationid =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getOperationid(new String(String.valueOf(position)));
                        String hrmssecid =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getHrmssecid(new String(String.valueOf(position)));

                        String designation =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getDesignation(new String(String.valueOf(position)));
                        String operation =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getOperation(new String(String.valueOf(position)));
                        String process =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getProcess(new String(String.valueOf(position)));
                        String section_name =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getSection_name(new String(String.valueOf(position)));
                        String qrcontractorid =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getQrcontractorid(new String(String.valueOf(position)));
                        String currentstatus =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getCurrentstatus(new String(String.valueOf(position)));
                        String current_inoutimte =((In_Employee_Operation_Mapping_View_Adapter) mAdapter).getCurrentstatus(new String(String.valueOf(position)));
                        Log.e("Bipin","type : " +type);

                        if(type.equals("Bundle_mapp"))
                        {
                            Intent intent = new Intent(In_Employee_Operation_Mapping_Activity.this, Employee_Bundle_Mapping_Activity.class);
                            intent.putExtra("processorid", processorid);
                        ...
                        {
                            Intent intent = new Intent(In_Employee_Operation_Mapping_Activity.this, Employee_Operation_Mapping_Details_Activity.class);
                            intent.putExtra("processorid", processorid);
                            intent.putExtra("empcode", empcode);
                            intent.putExtra("empname", empname);
                    ...
                    new AlertDialog.Builder(In_Employee_Operation_Mapping_Activity.this)
                        .setMessage(message)
                        .setCancelable(false)
