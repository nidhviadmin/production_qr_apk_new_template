...
public class Delivery_Details_Activity extends AppCompatActivity implements View.OnClickListener, GetResult.MyListener {
    ...
    public void onClick(View v) {
        if (isOnline()) {
            switch (v.getId()) {
                case R.id.imgd:
                    PopupMenu popup = new PopupMenu(Delivery_Details_Activity.this, imageView);
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            if (item.getItemId() == R.id.log) {
                                ...
                                Intent intent = new Intent(Delivery_Details_Activity.this, ChangepasswordActivity.class);
