...
//        ArrayList results = new ArrayList<Accessory_Receipt_Delivery_Data_Object>();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgd:
                PopupMenu popup = new PopupMenu(Accessory_Receipt_Delivery_Activity.this, imageView);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.log) {
                            ...
                            Intent intent = new Intent(Accessory_Receipt_Delivery_Activity.this, ChangepasswordActivity.class);
