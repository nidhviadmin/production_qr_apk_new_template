...
public class Roll_Delivery_USB_Reader_Activity extends AppCompatActivity implements View.OnClickListener, GetResult.MyListener {
    ...
    LinearLayout liner_bundle_details, linear_layout_btn, layout_text_4point;
    JSONObject rollinfo;
    ...
    LinearLayout layout_text_relaxed_by, layout_text_relaxed_on;
    ...
    private void handleScanData(String qrdata)
    {
        ...
        if (qrprefix.equals("RLX") || qrprefix.equals("RIN") || qrprefix.equals("RL") )
        {
            if (isOnline())
            {
                ...
                Roll_Delivery_USB_Reader_Activity.custPrograssbar.prograssCreate(this);
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(Roll_Delivery_USB_Reader_Activity.this)
            ...
            h.post(new Runnable() {
                public void run() {
                    new AlertDialog.Builder(Roll_Delivery_USB_Reader_Activity.this)
                            .setTitle("Error")
    ...
    private void downloadFile(String sUrl) {
        ...
        String apkUrl = sUrl;
        mProgressDialog = new ProgressDialog(Roll_Delivery_USB_Reader_Activity.this);
...
//                    checkForUpdates();
        ...
        try
        {
            ...
            if(callNo.equalsIgnoreCase("getjobdetails"))
            {
                ...
                if (mStatus.equalsIgnoreCase("new"))
                {
                    ...
                    Roll_Delivery_USB_Reader_Activity.custPrograssbar.closePrograssBar();
                    multiclick = true;
                }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Roll_Delivery_USB_Reader_Activity.this, MainActivity.class);
