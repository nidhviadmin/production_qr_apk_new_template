...
//        ArrayList results = new ArrayList<Fabric_Receipt_Data_Object>();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgd:
                PopupMenu popup = new PopupMenu(Fabric_Receipt_Activity.this, imageView);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.log) {
                            ...
                            Intent intent = new Intent(Fabric_Receipt_Activity.this, ChangepasswordActivity.class);
