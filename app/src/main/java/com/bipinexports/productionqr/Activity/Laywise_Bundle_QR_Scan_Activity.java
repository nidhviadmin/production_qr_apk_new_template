...
public class Laywise_Bundle_QR_Scan_Activity extends AppCompatActivity implements View.OnClickListener, GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laywise_bundle_qr_scan);
    ...
    private void versioncode() {
        if(isOnline()) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Laywise_Bundle_QR_Scan_Activity.this)
        ...
        if (isOnline()) {
            ...
            if (requestCode == 12345) { // Use the same request code as in the previous step
                ...
                if (result.getContents() == null) {
                    Toast t = Toast.makeText(Laywise_Bundle_QR_Scan_Activity.this, "\"Result Not Found", Toast.LENGTH_LONG);
                    t.show();
                }
                else {
                    ...
                    if (arrayString.length > 1 && (qrprefix.equals("NE")))
                    {
                        if(isOnline()) {
                            ...
                            if(cick_count == 0)
                            {
                                ...
                                Laywise_Bundle_QR_Scan_Activity.custPrograssbar.prograssCreate(this);
                        ...
                        h.post(new Runnable() {
                            public void run() {
                                new AlertDialog.Builder(Laywise_Bundle_QR_Scan_Activity.this)
                                        .setTitle("Error")
    ...
    public void onClick(View v) {
        ...
        if (isOnline()) {
            dialog = new Dialog(Laywise_Bundle_QR_Scan_Activity.this);
            switch (v.getId()) {
                case R.id.imgd:
                    PopupMenu popup = new PopupMenu(Laywise_Bundle_QR_Scan_Activity.this, imageView);
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            if (item.getItemId() == R.id.log) {
                                ...
                                Intent intent = new Intent(Laywise_Bundle_QR_Scan_Activity.this, ChangepasswordActivity.class);
         ...
         receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (downloadId == id) {
                    ...
                    Laywise_Bundle_QR_Scan_Activity.custPrograssbar.closePrograssBar();
                                        ...
                                        if(totalinsert_count > 0 && Integer.parseInt(index_no) == currindex)
                                        {
                                            ...
                                            textViewPcQr[currindex].setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    AlertDialog.Builder builder = new AlertDialog.Builder(Laywise_Bundle_QR_Scan_Activity.this);
    ...
    public void data_added() {
       ...
       if(arraycontain_data)
       {
           new AlertDialog.Builder(Laywise_Bundle_QR_Scan_Activity.this)
            ...
            {
                AlertDialog alertDialog = new AlertDialog.Builder(Laywise_Bundle_QR_Scan_Activity.this)
                        .setMessage("This Bundle # Not Avilable in This Lay / Please Scan Valid QR!")
                        .setCancelable(false)
                        .setNegativeButton("Exit", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface arg1, int arg0) {
                                arg1.dismiss();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Laywise_Bundle_QR_Scan_Activity.this, MainActivity.class);
