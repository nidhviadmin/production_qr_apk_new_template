...
public class Absent_Employee_Operation_Mapping_Activity extends AppCompatActivity implements View.OnClickListener, GetResult.MyListener {
    ...
    ArrayList results = new ArrayList<Absent_Employee_Data_Object>();
    int i = 0;
    ...
    private ArrayList<Absent_Employee_Data_Object> getDataSet() {
//        ArrayList results = new ArrayList<Absent_Employee_Data_Object>();
        try {
            ...
            while (employee_contents.hasNext()) {
                ...
                if (employee_jsonobj.get(key) instanceof JSONObject) {
                    ...
                    Absent_Employee_Data_Object obj = new Absent_Employee_Data_Object(empcode, empname, imgpath, hrmsrecid, operationid, hrmssecid,designation_name, operation_name, process_name, section_name, qrcontractorid, currentstatus, current_inoutimte, noofconsecutiveabsentdays, selecteddate, mobileno);
                    results.add(i, obj);
                    i++;
                }
            }
    ...
    public void clearfunc() {
        ...
        Intent intent = new Intent(Absent_Employee_Operation_Mapping_Activity.this, Empty_Employee_Data_Activity.class);
        intent.putExtra("type", type);
        intent.putExtra("processorid", processorid);
        intent.putExtra("myversionName", myversionName);
        intent.putExtra("selected_type", selected_type);
        Absent_Employee_Operation_Mapping_Activity.custPrograssbar_new.closePrograssBar();
    ...
    private void fetch_employee_Details() {
        ...
        Absent_Employee_Operation_Mapping_Activity.custPrograssbar_new.prograssCreate(this);
        if (mAdapter != null) {
            clearfunc();
        }
        else {
            ...
            try {
                ...
                call = APIClient.getInterface().fetch_employee_absent_details((JsonObject) jsonParser.parse(jsonObject.toString()));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgd:
                PopupMenu popup = new PopupMenu(Absent_Employee_Operation_Mapping_Activity.this, imageView);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.log) {
                            ...
                            Intent intent = new Intent(Absent_Employee_Operation_Mapping_Activity.this, ChangepasswordActivity.class);
                            startActivity(intent);
                            finish();
                        }
                        return true;
    ...
    public void onBackPressed() {
        session = new SessionManagement(getApplicationContext());
        HashMap<String, String> user = session.getUserDetails();
        Intent intent = new Intent(Absent_Employee_Operation_Mapping_Activity.this, Select_Employee_Detail_Activity.class);
        intent.putExtra("selected_type", selected_type);
        intent.putExtra("type", type);
        intent.putExtra("myversionName", myversionName);
        ...
        try {
            ...
            if (callNo.equalsIgnoreCase("employee_details")) {
                ...
                if (mStatus.equals("success")) {
                    ...
                    mLayoutManager = new LinearLayoutManager(Absent_Employee_Operation_Mapping_Activity.this);
                    mRecyclerView.setLayoutManager(mLayoutManager);
                    mAdapter = new Absent_Employee_Operation_Mapping_View_Adapter(this,getDataSet());
                    mRecyclerView.setAdapter(mAdapter);

                    ((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).setOnItemClickListener(new Absent_Employee_Operation_Mapping_View_Adapter.MyClickListener() {
                        @Override
                        public void onItemClick(int position, View v) {

                        String empcode =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getEmpcode(new String(String.valueOf(position)));
                        String empname =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getEmpname(new String(String.valueOf(position)));
                        String imgpath =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getImgpath(new String(String.valueOf(position)));
                        String hrmsrecid =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getHrmsrecid(new String(String.valueOf(position)));
                        String operationid =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getOperationid(new String(String.valueOf(position)));
                        String hrmssecid =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getHrmssecid(new String(String.valueOf(position)));

                        String designation =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getDesignation(new String(String.valueOf(position)));
                        String operation =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getOperation(new String(String.valueOf(position)));
                        String process =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getProcess(new String(String.valueOf(position)));
                        String section_name =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getSection_name(new String(String.valueOf(position)));
                        String qrcontractorid =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getQrcontractorid(new String(String.valueOf(position)));
                        String currentstatus =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getCurrentstatus(new String(String.valueOf(position)));
                        String current_inoutimte =((Absent_Employee_Operation_Mapping_View_Adapter) mAdapter).getCurrentstatus(new String(String.valueOf(position)));

                        if(type.equals("Bundle_mapp"))
                        {
                            Intent intent = new Intent(Absent_Employee_Operation_Mapping_Activity.this, Employee_Bundle_Mapping_Activity.class);
                            intent.putExtra("processorid", processorid);
                        ...
                        {
                            Intent intent = new Intent(Absent_Employee_Operation_Mapping_Activity.this, Employee_Operation_Mapping_Details_Activity.class);
                            intent.putExtra("processorid", processorid);
                            intent.putExtra("empcode", empcode);
                            intent.putExtra("empname", empname);
                    ...
                    new AlertDialog.Builder(Absent_Employee_Operation_Mapping_Activity.this)
                        .setMessage(message)
                        .setCancelable(false)
