...
public class Scan_Inward_Rolls_Activity extends AppCompatActivity implements View.OnClickListener, GetResult.MyListener {
    ...
    private void versioncode() {
        if(isOnline()) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Scan_Inward_Rolls_Activity.this)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (isOnline()) {
            ...
            else if (result != null)
            {
                ...
                {
                    Toast t = Toast.makeText(Scan_Inward_Rolls_Activity.this, "\"Result Not Found", Toast.LENGTH_LONG);
                    t.show();
                    onBackPressed();
                }
                else {
                    ...
                    if (qrprefix.equals("RIN") || qrprefix.equals("RL"))
                    {
                        if (isOnline())
                        {
                            ...
                            Scan_Inward_Rolls_Activity.custPrograssbar.prograssCreate(this);
                        ...
                        h.post(new Runnable() {
                            public void run() {
                                new AlertDialog.Builder(Scan_Inward_Rolls_Activity.this)
                                        .setTitle("Error")
    ...
    public void onClick(View v) {
        ...
        if (isOnline()) {
            dialog = new Dialog(Scan_Inward_Rolls_Activity.this);
            switch (v.getId()) {
                case R.id.imgd:
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            if (item.getItemId() == R.id.log) {
                                ...
                                Intent intent = new Intent(Scan_Inward_Rolls_Activity.this, ChangepasswordActivity.class);
        ...
        try {
           ...
           if(callNo.equalsIgnoreCase("getjobdetails"))
           {
               ...
               if (mStatus.equalsIgnoreCase("new"))
               {
                   ...
                   Scan_Inward_Rolls_Activity.custPrograssbar.closePrograssBar();
               }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Scan_Inward_Rolls_Activity.this, MainActivity.class);
