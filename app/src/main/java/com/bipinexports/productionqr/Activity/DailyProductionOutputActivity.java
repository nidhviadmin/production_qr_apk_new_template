...
//        ArrayList results = new ArrayList<DailyOutputDataObject>();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgd:
                PopupMenu popup = new PopupMenu(DailyProductionOutputActivity.this, imageView);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.log) {
                            ...
                            Intent intent = new Intent(DailyProductionOutputActivity.this, ChangepasswordActivity.class);
