...
import com.bipinexports.productionqrnew.AssignedDataObject;
import com.bipinexports.productionqrnew.R;

import java.util.ArrayList;

public class AssignedViewAdapter extends RecyclerView.Adapter<AssignedViewAdapter.DataObjectHolder> {
    private ArrayList<AssignedDataObject> mDataset;
    ...
    public AssignedViewAdapter(ArrayList<AssignedDataObject> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        if(mDataset.get(position).getWeekyear().equals("Grand Total"))
        {
            ...
            holder.BundleCnt.setText(mDataset.get(position).getAssignedbundlecnt().toString());
            ...
            holder.BundleQty.setText(mDataset.get(position).getAssignedbundleqty().toString());
            ...
            holder.BundlePrice.setText(mDataset.get(position).getAssignedprice().toString());
    ...
    public void addItem(AssignedDataObject dataObj, int index) {
