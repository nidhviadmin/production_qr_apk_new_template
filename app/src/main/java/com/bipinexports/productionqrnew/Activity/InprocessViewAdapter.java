...
import com.bipinexports.productionqrnew.InprocessDataObject;
import com.bipinexports.productionqrnew.R;

import java.util.ArrayList;

public class InprocessViewAdapter extends RecyclerView.Adapter<InprocessViewAdapter.DataObjectHolder> {
    private ArrayList<InprocessDataObject> mDataset;
    ...
    public InprocessViewAdapter(ArrayList<InprocessDataObject> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        if(mDataset.get(position).getWeekyear().equals("Grand Total"))
        {
            ...
            holder.BundleCnt.setText(mDataset.get(position).getInprocessbundlecnt().toString());
            ...
            holder.BundleQty.setText(mDataset.get(position).getInprocessbundleqty().toString());
            ...
            holder.BundlePrice.setText(mDataset.get(position).getInprocessprice().toString());
    ...
    public void addItem(InprocessDataObject dataObj, int index) {
