...
public class Out_Employee_Operation_Mapping_View_Adapter extends RecyclerView.Adapter<Out_Employee_Operation_Mapping_View_Adapter.DataObjectHolder> {
    private ArrayList<Out_Employee_Data_Object> mDataset;
    private static MyClickListener myClickListener;
    private Context mContext;

    public static class DataObjectHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView empcode, empname, designation, process, operation, txt_index, inOut, txt_mobile ;
        ImageView Emp_Imge;
    ...
    public Out_Employee_Operation_Mapping_View_Adapter(Context context, ArrayList<Out_Employee_Data_Object> myDataset) {
        mDataset = myDataset;
        mContext = context;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.out_emp_opeation_mapp_card_view_row, parent, false);
...
//        holder.designation.setTypeface(null, Typeface.BOLD);
        ...
        holder.inOut.getBackground().setColorFilter(Color.parseColor("#DC143C"), PorterDuff.Mode.SRC_IN);
    ...
    public void addItem(Out_Employee_Data_Object dataObj, int index) {
