...
import com.bipinexports.productionqrnew.Accessory_Receipt_Data_Object;
import com.bipinexports.productionqrnew.R;

import java.util.ArrayList;

public class Accessory_Receipt_View_Adapter extends RecyclerView.Adapter<Accessory_Receipt_View_Adapter.DataObjectHolder> {
    private ArrayList<Accessory_Receipt_Data_Object> mDataset;
    private static MyClickListener myClickListener;

    public static class DataObjectHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView PO_No, PO_Date, Vendor_Name, DC_No, DC_Date, Delivery_Type, Quantity, PO_No_Text ;
    ...
    public Accessory_Receipt_View_Adapter(ArrayList<Accessory_Receipt_Data_Object> myDataset) {
        mDataset = myDataset;
    }

    @Override
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.accessory_receipt_card_view_row, parent, false);
    ...
    public void addItem(Accessory_Receipt_Data_Object dataObj, int index) {
