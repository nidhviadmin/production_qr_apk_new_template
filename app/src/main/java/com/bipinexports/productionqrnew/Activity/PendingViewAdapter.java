...
import com.bipinexports.productionqrnew.PendingDataObject;
import com.bipinexports.productionqrnew.R;

import java.util.ArrayList;

public class PendingViewAdapter extends RecyclerView.Adapter<PendingViewAdapter.DataObjectHolder> {
    private ArrayList<PendingDataObject> mDataset;
    ...
    public PendingViewAdapter(ArrayList<PendingDataObject> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        if(mDataset.get(position).getWeekyear().equals("Grand Total"))
        {
            ...
            holder.BundleCnt.setText(mDataset.get(position).getPendingbundlecnt().toString());
            ...
            holder.BundleQty.setText(mDataset.get(position).getPendingbundleqty().toString());
            ...
            holder.BundlePrice.setText(mDataset.get(position).getPendingprice().toString());
    ...
    public void addItem(PendingDataObject dataObj, int index) {
