...
import com.bipinexports.productionqrnew.DatewiseDataObject;
import com.bipinexports.productionqrnew.R;

import java.util.ArrayList;

public class DatewiseoutputViewAdapter extends RecyclerView.Adapter<DatewiseoutputViewAdapter.DataObjectHolder> {
    private ArrayList<DatewiseDataObject> mDataset;
    ...
    public DatewiseoutputViewAdapter(ArrayList<DatewiseDataObject> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        {
            holder.weekyear.setText(mDataset.get(position).getDay());
            holder.weekyear.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
    ...
    public void addItem(DatewiseDataObject dataObj, int index) {
    ...
    public String getDate(int index) {
        return mDataset.get(index).getDate();
    }
